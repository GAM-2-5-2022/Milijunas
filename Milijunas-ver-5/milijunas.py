...
druga_opcija = ['MS PPT','Isaac Newton','Steve Jobs','Wireless Film',
...
cetvrta_opcija = ['MS Paint','A. Volta','Elon Musk','World Finder',
                  'DAN','A. M.','Marin Držić','J. Haydn',
...
treca_opcija_gumb = Button(donji_okvir, text = cetvrta_opcija[0], font = ('arial',18, 'bold'), bg = 'black', fg = 'white', bd = 0, activebackground = 'black', activeforeground = 'white', cursor = 'hand2')
treca_opcija_gumb.place(x = 370, y = 180)
